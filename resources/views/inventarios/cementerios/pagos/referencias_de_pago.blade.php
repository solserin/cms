                ...
                <tbody>
                    <tr>
                       <td width="15%">
                         ...
                         <td width="40%" align="center">
                          <span class="bg-dato">
                          <span class="dato">Fecha Programada: </span> <span class="valor">{{fecha_no_day($pago['fecha_programada'])}}</span>
                          </span> 
                        </td>
                ...
                <tbody>
                    <tr>
                       <td width="50%">
                         ...
                         <p class="digitos">
                          @for($i = 0; $i < strlen($pago['referencia_pago']); $i++)
                         <span class="digito">{{$pago['referencia_pago'][$i]}}</span>
                          @endfor
                        </p>
                        <!--<div class="barcode">
                      ...
                      <!--<p class="sello">
                        ...
                        <p class="ojo">
                         <strong>NOTA</strong>: Por ningun motivo será considerado como comprobante de pago sin el sello del banco o el número de operación que resulte de hacer el pago por cualquier otro medio. <strong>El titular deberá guardar los recibos para futuras aclaraciones</strong>.
                        </p>
