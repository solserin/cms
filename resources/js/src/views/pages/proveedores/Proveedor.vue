      ...
      <form>
        ...
        <div class="vx-row w-full mt-4">
          <div class="vx-col w-full md:w-5/12">
            ...
            >{{ errors.first('nombre-comercial', 'add-proveedor', 'add-proveedor') }}</span>
          </div>
        ...
        <div class="vx-row w-full mt-4">
          <div class="vx-col w-full md:w-5/12">
            ...
            <vs-input
              ...
              data-vv-as="Nombre del contacto"
              icon-pack="feather"
              icon="icon-user"
              v-validate="'required'"
              type="text"
          ...
          <div class="vx-col w-full md:w-4/12">
            ...
            <vs-input
              ...
              data-vv-as="Telefono de contacto"
              icon-pack="feather"
              icon="icon-phone"
              v-validate="'required'"
              type="text"
            ...
            <span
              class="text-danger text-sm"
            >{{ errors.first('telefono-contacto', 'add-proveedor') }}</span>
          </div>
          <div class="vx-col w-full md:w-3/12">
            <label class="text-sm opacity-75">
              Correo electronico
            ...
            <span
              class="text-danger text-sm"
            >{{ errors.first('correo-electronico', 'add-proveedor') }}</span>
          </div>
        </div>
        <div class="vx-row w-full md:mt-4">
          <div class="vx-col w-full md:w-5/12">
            <label class="text-sm opacity-75">Sitio WEB</label>
            <vs-input
              data-vv-scope="add-proveedor"
              v-model="proveedor.pagina_web"
              name="sitio-web"
        ...
        <div class="vx-row mt-4">
          <div class="vx-col w-full md:w-1/3">
            ...
            <span
              class="text-danger text-sm"
              v-show="errors.has('pais', 'add-proveedor')"
            >{{ errors.first('pais', 'add-proveedor') }}</span>
          </div>
          <div class="vx-col w-full md:w-1/3">
            <label for class="vs-input--label">
              Estado
            ...
            <span
              class="text-danger text-sm"
              v-show="errors.has('estado', 'add-proveedor')"
            >{{ errors.first('estado', 'add-proveedor') }}</span>
          </div>
          <div class="vx-col w-full md:w-1/3">
            <label for class="vs-input--label">
              Ciudad
            ...
            <span
              class="text-danger text-sm"
              v-show="errors.has('ciudad', 'add-proveedor')"
            >{{ errors.first('ciudad', 'add-proveedor') }}</span>
          </div>
        </div>
  ...
  watch: {
    show: function() {
      ...
      if (!this.showPopup) {
        ...
        for (let member in this.proveedor) this.proveedor[member] = null;
