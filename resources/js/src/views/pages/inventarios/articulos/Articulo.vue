        ...
        <div v-show="activeTab == 0">
          <div class="vx-row">
              ...
              <div class="flex content-end flex-wrap">
                <div class="w-1/3">
                  <div class="text-center items-center">
                    <img
                      :src="imagen ? 'data:image/png;base64, ' + imagen : require('@assets/images/no-image-icon.png')"
                      class="rounded h-32 w-32"
                    />
                    <div class="w-full items-center flex justify-center">
                      <vs-button
                        @click="uploadImage('update_image')"
                        icon-pack="feather"
                        icon="icon-upload"
                        class="mb-4"
                        size="small"
                      >Subir Imagen</vs-button>
                      <input
                ...
                <div class="w-1/3">
                  <div class="text-center">
                    <img
                      :src="imagen1 ? 'data:image/png;base64, ' + imagen1 : require('@assets/images/no-image-icon.png')"
                      class="rounded h-32 w-32"
                    />
                    <div class="w-full items-center flex justify-center">
                      <vs-button
                        :disabled="!imagen"
                        @click="uploadImage('update_image1')"
                        icon-pack="feather"
                        icon="icon-upload"
                        class="mb-4"
                        size="small"
                ...
                <div class="w-1/3">
                  <div class="text-center">
                    <img
                      :src="imagen2 ? 'data:image/png;base64, ' + imagen2 : require('@assets/images/no-image-icon.png')"
                      class="rounded h-32 w-32"
                    />
                    <div class="w-full items-center flex justify-center">
                      <vs-button
                        :disabled="!imagen1"
                        @click="uploadImage('update_image2')"
                        icon-pack="feather"
                        icon="icon-upload"
                        class="mb-4"
                        size="small"
            ...
            <div class="vx-col w-full md:w-3/12">
              ...
              <vs-input
                ...
                v-model="articulo.codigo_barras"
                name="codigo_barras"
                data-vv-as="Codigo de barras"
            ...
            <div class="vx-col w-full md:w-3/12">
              ...
              <v-select
                data-vv-scope="add-articulo"
                class="w-full pb-1 pt-1"
                v-model="selectedTipoProductoSAT"
                :clearable="false"
                name="sat_productos_servicios_id"
                data-vv-as="Tipo de producto/servicio SAT"
                v-validate="'required'"
                :options="tiposProductosSAT"
              >
                <div slot="no-options">No hay opciones disponibles.</div>
              </v-select>
              <span
                class="text-danger text-sm"
              >{{ errors.first('sat_productos_servicios_id', 'add-articulo') }}</span>
            </div>
            <div class="vx-col w-full md:w-3/12 mt-4">
              ...
              <v-select
                data-vv-scope="add-articulo"
                class="w-full pb-1 pt-1"
                v-model="selectedGrupoProfeco"
                :clearable="false"
                name="grupo_profeco"
                data-vv-as="Grupo profeco"
                v-validate="'required'"
                :options="gruposProfeco"
              >
                <div slot="no-options">No hay opciones disponibles.</div>
              </v-select>
            ...
            <div class="vx-col w-full md:w-3/12 mt-4">
              ...
              <vs-input
                data-vv-scope="add-articulo"
                v-model="articulo.cuenta_predial"
                name="cuenta_predial"
                data-vv-as="cuenta predial"
                v-validate="'numeric'"
                type="text"
                class="w-full pb-1 pt-1"
              />
              ...
              <div class="vx-row">
                <div class="vx-col w-full md:w-6/12">
                  ...
                  <vs-input
                    ...
                    name="minimo"
                    data-vv-as="Minimo"
                    v-validate="rulesIventarioMinimo"
                    type="text"
                    class="w-full pb-1 pt-1"
                  />
                ...
                <div class="vx-col w-full md:w-6/12">
                  ...
                  <vs-input
                    ...
                    name="maximo"
                    data-vv-as="Maximo"
                    v-validate="rulesInventarioMaximo"
                    type="text"
                    class="w-full pb-1 pt-1"
                  />
            ...
            >
              <ul class="centerx options">
                <li>
                  <vs-checkbox v-model="articulo.facturable">Facturable</vs-checkbox>
                </li>
                <li>
                  <vs-checkbox
                ...
                <li>
                  <vs-checkbox v-model="articulo.rentable">Rentable</vs-checkbox>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="vx-row mt-4">
            <div class="vx-col w-full" :class="classPrices">
              ...
              <vs-input
                data-vv-scope="add-articulo"
                v-model="articulo.costo_neto"
                name="costo-neto"
                data-vv-as="Costo neto"
            ...
            <div class="vx-col w-full" :class="classPrices">
              ...
              <v-select
                data-vv-scope="add-articulo"
                class="w-full pb-1 pt-1"
                v-model="selectedUnidadCompra"
                :clearable="false"
                name="unidad_compra"
                data-vv-as="Unidad de compra"
                v-validate="'required'"
                :options="unidades"
              >
                <div slot="no-options">No hay opciones disponibles.</div>
            ...
            <div class="vx-col w-full" :class="classPrices">
              ...
              <v-select
                data-vv-scope="add-articulo"
                class="w-full pb-1 pt-1"
                v-model="selectedUnidadVenta"
                :clearable="false"
                name="unidad_venta"
                data-vv-as="Unidad de venta"
                v-validate="'required'"
                :options="unidades"
              >
                <div slot="no-options">No hay opciones disponibles.</div>
            ...
            <div class="vx-col w-full" :class="classPrices">
              ...
              <vs-input
                data-vv-scope="add-articulo"
                v-model="preciosVenta.precio1"
                name="precio1"
                data-vv-as="Precio de venta"
                v-validate="'required|decimal:2'"
                type="text"
                class="w-full"
              />
            ...
            <div class="vx-col w-full" :class="classPrices">
              ...
              <vs-input
                data-vv-scope="add-articulo"
                v-model="preciosVenta.precio2"
                name="precio2"
                data-vv-as="Precio de venta con descuento"
                v-validate="'required|decimal:2'"
                type="text"
                class="w-full"
              />
            ...
            <div class="vx-col w-full" :class="classPrices">
              ...
              <v-select
                ...
                multiple
                class="w-full pb-1 pt-1"
                v-model="selectedRetenciones"
                name="retenciones"
                data-vv-as="Retenciones"
                :options="retenciones"
              >
                <div slot="no-options">No hay opciones disponibles.</div>
              </v-select>
            ...
            <div class="vx-row">
              ...
              <div class="vx-col w-full">
                ...
                <vs-table
                  :hoverFlat="false"
                  stripe
                  noDataText="Aun no has agregado articulos al paquete"
                  :data="paqueteProductos"
                  class="mt-4"
                >
                  <template slot="thead">
                  ...
                  <template slot-scope="{data}">
                    <vs-tr :data="articulo" :key="indextr" v-for="(articulo, indextr) in data">
                      <vs-td>
                        ...
                        <span
                          class="text-danger text-sm"
                        >{{ errors.first('articulo' + indextr, 'add-articulo') }}</span>
                      </vs-td>
                      <vs-td>{{ articulo.codigo_barras }}</vs-td>
                      <vs-td>{{ articulo.nombre }}</vs-td>
                      <vs-td>
                        <vs-button
                          @click="onDeleteFromPackage(indextr)"
...
export default {
  ...
  watch: {
    show: function() {
      ...
      if (this.articuloData) {
        ...
        if (this.articulo.impuestos) {
          this.selectedImpuestos = _.map(this.articulo.impuestos, impuesto => ({
            value: impuesto.sat_impuesto.id,
            label: impuesto.sat_impuesto.impuesto
          }));
          this.selectedRetenciones = _.map(
            this.articulo.retenciones,
            retencion => ({
              value: retencion.sat_impuesto.id,
              label: retencion.sat_impuesto.impuesto
            })
          );
        }
      ...
      if (!this.showPopup) {
        ...
        for (let member in this.articulo) this.articulo[member] = null;
    ...
    selectedTipoProducto: function() {
      if (this.selectedTipoProducto) {
        ...
        if (
          this.selectedTipoProducto.value === 2 ||
          this.selectedTipoProducto.value === 1
        ) {
  ...
  methods: {
    ...
    save() {
      ...
      self.$validator.validate("add-articulo.*").then(result => {
        if (result) {
          ...
          self.articulo.sat_productos_servicios_id =
            self.selectedTipoProductoSAT.value;
          ...
          self.articulo.impuestos = _.map(
            self.selectedImpuestos,
            impuesto => impuesto.value
          );
          self.articulo.retenciones = _.map(
            self.selectedRetenciones,
          ...
          if (self.isPaquete && self.paqueteProductos.length === 0) {
            self.$vs.notify({
              ...
              title: "Advertencia",
              text:
                "Estas creando un paquete pero aun no has agregado ningun articulo a este, porfavor ve a la pestaña Articulos del paquete para agregar al menos un articulo"
            });
            return false;
          }
          ...
          self.$vs.notify({
            ...
            title: "Advertencia",
            text:
              "Se han detectado errores de validacion, porfavor revisa todos los campos"
          });
        }
      });
    },
    getFamilias() {
      ...
      return articuloService
        .getFamilias(this.selectedCategoria.value)
        .then(response => (this.familias = response.data.data));
    },
    cancel() {
      this.$emit("update:show", false);
      this.$emit("on-cancel");
  ...
  created() {
    ...
    Promise.all([
      articuloService
        .tiposProductos()
        .then(response => (this.tiposProductos = response.data.data)),
      articuloService
        .grouposProfeco()
        .then(response => (this.gruposProfeco = response.data.data)),
      articuloService
        .almacenes()
        .then(response => (this.almacenes = response.data.data)),
      articuloService
        .categorias()
        .then(response => (this.categorias = response.data.data)),
      articuloService
        .impuestos()
        .then(response => (this.impuestos = response.data.data)),
      articuloService
        .retenciones()
        .then(response => (this.retenciones = response.data.data)),
      articuloService
        .unidades()
        .then(response => (this.unidades = response.data.data)),
      articuloService
        .productosServicios()
        .then(response => (this.tiposProductosSAT = response.data.data))
    ]).then(allPromises => {
      self.$vs.loading.close();
    });
  }
