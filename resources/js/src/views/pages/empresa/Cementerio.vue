        ...
        <div class="mt-4 pb-3" v-if="funeraria">
            ...
            <div class="vx-row">
                <div class="vx-col w-full mt-3 md:w-3/5">
                    ...
                    <vs-input class="w-full uppercase"  icon-pack="feather" icon="icon-user" data-vv-as="Nombre comercial" v-model="cementerio.cementerio" v-validate="'required'"  name="cementerio"/>
                ...
                <div class="vx-col w-full mt-3 md:w-1/5">
                    ...
                    <vs-input class="w-full uppercase"  data-vv-as="Telefonos" icon-pack="feather" icon="icon-phone" v-model="cementerio.telefonos" v-validate="'required'" name="telefonos"/>
                    <span class="text-danger text-sm" v-show="errors.has('telefonos')">{{ errors.first('telefonos') }}</span>
                </div>
                <div class="vx-col w-full mt-3 md:w-1/5">
                    <vs-input class="w-full uppercase"  data-vv-as="Fax" icon-pack="feather" icon="icon-file" v-model="cementerio.fax" label="Fax:" name="fax"/>
                </div>
            </div>
            ...
            <div class="vx-row">
                <div class="vx-col w-full md:w-3/12 mt-3">
                    ...
                    <vs-input  name="calle" icon-pack="feather" icon="icon-map" data-vv-as="Calle" v-validate="'required'" v-model="cementerio.calle" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-2/12 mt-3">
                    ...
                    <vs-input  name="num_ext" icon-pack="feather" icon="icon-map" data-vv-as="Numero exterior" v-validate="'required'" v-model="cementerio.num_ext" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-2/12 mt-3">
                    ...
                    <vs-input  name="num_int" icon-pack="feather" icon="icon-map" data-vv-as="Numero interior" v-model="cementerio.num_int" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-3/12 mt-3">
                    ...
                    <vs-input  name="colonia" icon-pack="feather" icon="icon-map" data-vv-as="Colonia" v-validate="'required'" v-model="cementerio.colonia" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-2/12 mt-3">
                    ...
                    <vs-input  name="cp" icon-pack="feather" icon="icon-map" data-vv-as="C.P." v-validate="'required|numeric'" v-model="cementerio.cp" class="w-full uppercase"/>
            ...
            <div class="vx-row">
                <div class="vx-col w-full">
                    <div class="flex flex-wrap items-center justify-end">
                        <vs-button size="small" class="ml-auto mt-2" icon-pack="feather" icon="icon-save" @click.prevent="save">Guardar Cementerio</vs-button>
                    </div>
                </div>
            </div>
        </div>
