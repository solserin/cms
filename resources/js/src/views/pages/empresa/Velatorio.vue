        ...
        <div class="mt-4 pb-3" v-if="funeraria">
            ...
            <div class="vx-row">
                <div class="vx-col w-full mt-3 md:w-3/5">
                    ...
                    <vs-input class="w-full uppercase"  icon-pack="feather" icon="icon-user" data-vv-as="Nombre comercial" v-model="velatorio.velatorio" v-validate="'required'" name="velatorio"/>
                ...
                <div class="vx-col w-full mt-3 md:w-1/5">
                    ...
                    <vs-input class="w-full uppercase"  data-vv-as="Telefonos" icon-pack="feather" icon="icon-phone" v-model="velatorio.telefonos" v-validate="'required'" name="telefonos"/>
                    <span class="text-danger text-sm" v-show="errors.has('telefonos')">{{ errors.first('telefonos') }}</span>
                </div>
                <div class="vx-col w-full mt-3 md:w-1/5">
                    <vs-input class="w-full uppercase"  data-vv-as="Fax" icon-pack="feather" icon="icon-file" v-model="velatorio.fax" label="Fax:" name="fax"/>
                </div>
            </div>
            ...
            <div class="vx-row">
                <div class="vx-col w-full md:w-3/12 mt-3">
                    ...
                    <vs-input  name="calle" icon-pack="feather" icon="icon-map" data-vv-as="Calle" v-validate="'required'" v-model="velatorio.calle" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-2/12 mt-3">
                    ...
                    <vs-input  name="num_ext" icon-pack="feather" icon="icon-map" data-vv-as="Numero exterior" v-validate="'required'" v-model="velatorio.num_ext" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-2/12 mt-3">
                    ...
                    <vs-input  name="num_int" icon-pack="feather" icon="icon-map" data-vv-as="Numero interior" v-model="velatorio.num_int" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-3/12 mt-3">
                    ...
                    <vs-input  name="colonia" icon-pack="feather" icon="icon-map" data-vv-as="Colonia" v-validate="'required'" v-model="velatorio.colonia" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-2/12 mt-3">
                    ...
                    <vs-input  name="cp" icon-pack="feather" icon="icon-map" data-vv-as="C.P." v-validate="'required|numeric'" v-model="velatorio.cp" class="w-full uppercase"/>
            ...
            <div class="vx-row">
                <div class="vx-col w-full md:w-1/3 mt-3">
                    ...
                    <vs-input  name="sala_1" icon-pack="feather" icon="icon-home" data-vv-as="Sala 1" v-validate="'required'" v-model="salas[0]" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-1/3 mt-3">
                    ...
                    <vs-input  name="sala_2" icon-pack="feather" icon="icon-home" data-vv-as="Sala 2" v-validate="'required'" v-model="salas[1]" class="w-full uppercase"/>
                ...
                <div class="vx-col w-full md:w-1/3 mt-3">
                    ...
                    <vs-input  name="sala_3" icon-pack="feather" icon="icon-home" data-vv-as="Sala 3" v-validate="'required'" v-model="salas[2]" class="w-full uppercase"/>
