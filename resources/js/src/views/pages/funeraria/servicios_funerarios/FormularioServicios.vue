      ...
      <div class="venta-details">
                  ...
                  <template slot-scope="{ data }">
                    <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                      ...
                      <vs-td class="w-2/12">
                        ...
                        />
                        <div>
                          <span class="text-danger text-xs">{{ errors.first("cantidad" + indextr) }}</span>
                        </div>
                      </vs-td>
        ...
        <div class="tab-content mt-1" v-show="activeTab == 5">
          <div class="flex flex-wrap">
            ...
            <div class="w-full sm:w-12/12 md:w-12/12 lg:w-12/12 xl:w-12/12 px-2 mt-5">
              <div class="float-left pb-5 px-2" v-if="verLista">
                <img width="36px" src="@assets/images/articulos.svg" />
                <h3
                  class="float-right mt-2 ml-3 text-xl px-2 py-1 bg-seccion-forms capitalize"
                >Servicios y Artículos del Plan Funerario Seleccionado</h3>
              </div>
              ...
              <div class="flex flex-wrap">
                        ...
                        <template slot-scope="{ data }">
                          ...
                          <vs-tr v-if="form.plan_funerario_futuro_b.value == 1">
                            ...
                            <vs-td class="w-2/12">
                              ...
                              >{{ datosPlanFunerario.fecha_operacion_texto }}</div>
                            </vs-td>
                          </vs-tr>
                          <vs-tr v-if="form.plan_funerario_futuro_b.value == 1">
                            <vs-td class="w-1/12"></vs-td>
                          ...
                          >
                            ...
                            <vs-td class="w-7/12">
                              <div
                                class="capitalize py-1 text-right pr-4 dato_servicio"
                              >Plan Funerario de Uso Inmediato</div>
                            </vs-td>
                            <vs-td class="w-2/12">
                              <div
                                v-if="datosPlanFunerario != []"
                                class="capitalize dato_servicio_valor"
                              >{{ form.plan_funerario.label }}</div>
                            </vs-td>
                          </vs-tr>
                          <vs-tr
                            v-if="
                ...
                >
                  <label class="text-sm opacity-75 font-bold">
                    ...
                    <span
                      class="texto-importante"
                      v-if="form.plan_funerario_inmediato_b.value == 1"
                    >(*)</span>
                  </label>
                  <v-select
                ...
                <div class="w-full mt-5">
                  ...
                  <vx-card no-radius>
                    <div class="flex flex-wrap">
                      <div class="w-full sm:w-12/12 md:w-12/12 lg:w-12/12 xl:w-12/12 md:text-right">
                        <vs-button
                          size="small"
                          color="success"
                              ...
                              >
                                ...
                                <template slot-scope="{ data }">
                                  <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                                    ...
                                    <vs-td>
                                      <div class="capitalize">{{ data[indextr].tipo }}</div>
                                    </vs-td>
                                    <vs-td>
                                      <div class="capitalize">{{ data[indextr].descripcion }}</div>
                                    </vs-td>
                                    <vs-td>
                                      <div class="capitalize">{{ data[indextr].lote }}</div>
                                    </vs-td>
                                    <vs-td>
                                      <vs-input
                                        :name="
                                    ...
                                    >
                                      <vs-input
                                        ...
                                        data-vv-validate-on="blur"
                                        v-validate="
                                          'required|decimal:2|min_value:' + 0+'|max_value:'+ form.articulos_servicios[indextr]
                                            .costo_neto_normal
                                        "
                                        class="w-full sm:w-8/12 md:w-7/12 lg:w-7/12 xl:w-7/12 mr-auto ml-auto mt-1 cantidad"
                                        maxlength="10"
                                    ...
                                    >
                                      <div
                                        class="capitalize"
                                        v-if="form.articulos_servicios[indextr]
                                            .descuento_b==1"
                                      >
                                        $
                                        {{
                                        form.articulos_servicios[indextr].costo_neto_descuento* form.articulos_servicios[indextr].cantidad
                                        | numFormat("0,000.00")
                                        }}
                                      </div>
                                      <div class="capitalize" v-else>
                                        $
                                        {{
                                        form.articulos_servicios[indextr].costo_neto_normal* form.articulos_servicios[indextr].cantidad
                                        | numFormat("0,000.00")
                                        }}
                                      </div>
                                    </vs-td>
                                    ...
                                    <vs-td
                                      v-if="habilitar_plan_funerario_b == false ||
                                        form.articulos_servicios[indextr]
                                          .plan_b == 0"
                                    >
                                      <vs-switch
