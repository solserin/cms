                                    ...
                                    <vs-td
                                      v-if="
                                        habilitar_plan_funerario_b == false  
                                         || (habilitar_plan_funerario_b == true && form.plan_funerario_futuro_b.value==1 && form.articulos_servicios[indextr]
                                          .plan_b == 0) ||
                                        (habilitar_plan_funerario_b == true && form.plan_funerario_futuro_b.value==0 && form.plan_funerario_inmediato_b.value==1)
                                      "
                                    >
                                      <vs-input
                                        :name="
                          ...
                          <div class="flex flex-wrap">
                            <div class="w-full pt-3 pb-3 px-2">
                              <div class="float-left">
                                ...
                                >Notas / Observaciones Sobre el Contrato</h3>
                              </div>
                            </div>
                            <div class="w-full sm:w-12/12 md:w-12/12 lg:w-12/12 xl:w-12/12 px-2">
                          ...
                          <div class="flex flex-wrap">
                            <div class="w-full pt-3 pb-3 px-2">
                              <div class="float-left">
                                ...
                                <h3
                                  class="float-right mt-2 ml-3 text-xl font-medium px-2 py-1 bg-seccion-forms"
                                >Total del Contrato Funerario</h3>
                              </div>
                            </div>
                          </div>
                          <div class="flex flex-wrap">
                            ...
                            >
                              <label class="text-lg opacity-75">$ Total de plan de uso inmediato</label>
