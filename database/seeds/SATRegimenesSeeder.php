...
class SATRegimenesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('sat_regimenes')->insert(['clave' => 609, 'regimen' => 'Consolidación']);
        DB::table('sat_regimenes')->insert(['clave' => 610, 'regimen' => 'Residentes en el Extranjero sin Establecimiento Permanente en México']);
        DB::table('sat_regimenes')->insert(['clave' => 611, 'regimen' => 'Ingresos por Dividendos (socios y accionistas)']);
        DB::table('sat_regimenes')->insert(['clave' => 612, 'regimen' => 'Personas Físicas con Actividades Empresariales y Profesionales']);
        ...
        DB::table('sat_regimenes')->insert(['clave' => 622, 'regimen' => 'Actividades Agrícolas, Ganaderas, Silvícolas y Pesqueras']);
        ...
        DB::table('sat_regimenes')->insert(['clave' => 628, 'regimen' => 'Hidrocarburos']);
