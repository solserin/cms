...
class CreateCrematoriosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crematorios', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('crematorios');
    }
}
