...
class CreateArticulosRetencionesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('articulos_retenciones', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('articulos_retenciones');
    }
}
